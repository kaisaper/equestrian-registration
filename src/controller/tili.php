...
function lisaaTili($formdata, $baseurl='') {
  ...
  if (!$error) {
    ...
    $riderid = lisaaHenkilo($nimi,$email,$salasana);
...
function lahetaVahvavain($email,$url) {
  $message = "Hei!\n\n" . 
             "Olet rekisteröitynyt Unify-palveluun tällä\n" . 
             "sähköpostiosoitteella. Klikkaamalla alla olevaa\n" . 
             "linkkiä vahvistat käyttämäsi sähköpostiosoitteen\n" .
             "ja pääset käyttämään Unify-palvelua.\n\n" . 
             "$url\n\n" .
             "Jos et ole rekisteröitynyt Unify-palveluun, niin\n" . 
             "silloin tämä sähköposti on tullut sinulle\n" .
             "vahingossa. Siinä tapauksessa ole hyvä ja\n" .
             "poista tämä viesti.\n\n".
             "Terveisin, Unify-palvelu";
  return mail($email,'Unify-tilin aktivointilinkki',$message);
}
...
function lahetaVaihtoavain($email,$url) {
  $message = "Hei!\n\n" .
             ...
             "Terveisin, Unify-palvelu";
  return mail($email,'Unify-tilin salasanan vaihtaminen',$message);
}
